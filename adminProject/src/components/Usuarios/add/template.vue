    ...
    <div id="app">
        <div class="pag-info">
            <div class="page-titles">
                ...
                <p class='page-title active'>Adicionar</p>
            </div>
        ...
        <form v-on:submit.prevent='saveForm()'>
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input type="password" name="usu_password" id="usu_password" v-model="usuarioForm.usu_password" class="form-control" placeholder="Altere a senha deste usuário" :class="{'is-invalid': $v.usuarioForm.usu_password.$error}">
                    <p class='error-message' v-if='!$v.usuarioForm.usu_password.required'>Campo obrigatório</p>
